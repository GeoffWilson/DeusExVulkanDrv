# Cross-compile 64-bit Windows programs from Linux with clang-cl + lld-link,
...
if(NOT DEFINED XWIN_DIR)
	set(XWIN_DIR "${CMAKE_CURRENT_LIST_DIR}/../../.xwin-x64" CACHE PATH "xwin splat output directory")
endif()
...
set(_XWIN_FLAGS "--target=x86_64-pc-windows-msvc -fuse-ld=lld-link")
...
set(_XWIN_LINK_FLAGS "/machine:x64")
foreach(_dir crt/lib/x86_64 sdk/lib/ucrt/x86_64 sdk/lib/um/x86_64)
